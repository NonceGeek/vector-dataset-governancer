...
export default function Home() {
  ...
  function proposal_to_backend() {
    ...
    newAxios
      .post('/proposal', {
        ...
        contributor: account!.address!.toString(),
      })
      .then((res) => {
        console.log(res)
      })
  ...
  async function get_voters() {
    await client_sdk.view(payload).then((result) => {
      setVoters(result[0] as any)
  ...
  return (
    <div>
      ...
      <div className="overflow-x-auto mt-2">
        <h3 className="text-center font-bold">Voters</h3>
