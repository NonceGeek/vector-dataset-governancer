...
const basePath = "/vector-dataset-governancer" || 0;
...
const basePath = (/* unused pure expression or super */ null && ("/vector-dataset-governancer" || 0));
...
const configEnv = {"deviceSizes":[640,750,828,1080,1200,1920,2048,3840],"imageSizes":[16,32,48,64,96,128,256,384],"path":"/vector-dataset-governancer/_next/image","loader":"default","dangerouslyAllowSVG":false,"unoptimized":false};
...
class Router {
   ...
   */ prefetch(url, asPath = url, options = {}) {
    ...
    constructor(pathname1, query1, as1, { initialProps , pageLoader , App , wrapApp , Component , err , subscription , isFallback , locale , locales , defaultLocale , domainLocales , isPreview  }){
        ...
        this.basePath = "/vector-dataset-governancer" || 0;
